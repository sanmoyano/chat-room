...
const Modal = ({ display, handleClose } : {display : boolean, handleClose: () => void}) => {
  ...
  return (
    <div aria-hidden='true' className={`fixed top-0 left-0 right-0 z-50 ${display ? 'flex' : 'hidden'} w-full p-4 overflow-x-hidden overflow-y-hidden md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
